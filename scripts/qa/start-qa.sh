...
echo "  QA_SSH_DEST — user@host as seen from your laptop (default: whoami@hostname -f)."
echo "  QA_SSH_PORT — only if SSH is not on port 22; adds -p / -P to the printed ssh and scp lines."
