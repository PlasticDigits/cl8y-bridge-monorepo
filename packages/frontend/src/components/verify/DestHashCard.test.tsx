...
describe('DestHashCard', () => {
  ...
  it('should show Executed state label', () => {
    render(<DestHashCard data={mkWithdraw({ executed: true, approved: true })} />)
    expect(screen.getByText('Executed')).toBeInTheDocument()
  })

  it('should show Canceled state label', () => {
    render(<DestHashCard data={mkWithdraw({ cancelled: true })} />)
    expect(screen.getByText('Canceled')).toBeInTheDocument()
  })

  it('should show Approved state label', () => {
    render(<DestHashCard data={mkWithdraw({ approved: true })} />)
