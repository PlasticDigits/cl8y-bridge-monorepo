...
| [Frontend bridge UI invariants](./docs/FRONTEND_BRIDGE_INVARIANTS.md) | Recipient field (INV-RCP1; GL-117); mobile shell below sticky nav (INV-MOB1; [GL-103](https://gitlab.com/PlasticDigits/yieldomega/-/issues/103)) |
